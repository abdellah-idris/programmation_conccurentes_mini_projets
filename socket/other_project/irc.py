...
top.title("Internet Relay Chat | Utilisateur : "+str(username))
...
entry_field = tkinter.Entry(top, textvariable= my_msg, bg='white')
...
# Clear les messages sur l'écran
def clear_frame():
    msg_list.delete(0, END)

clear_button = tkinter.Button(top, text="Clear", command= clear_frame, bg='white')
clear_button.pack()
